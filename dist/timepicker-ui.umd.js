!(function (e, i) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["exports"], i)
    : i(
        ((e = "undefined" != typeof globalThis ? globalThis : e || self).tui =
          {})
      );
})(this, function (e) {
  "use strict";
  ...
  const t = (e, i, t = !1) => {
      ...
      return 0 !== Object.keys(c).length || c.constructor !== Object
        ? c
        : void 0;
    },
    ...
    a = (e, i, t) => ((e, i) => Math.round(e / i) * i)(e, i * t);
  function c(e, i) {
    void 0 === i && (i = {});
    var t = i.insertAt;
  ...
  const u = {
    ...
    p = "mousedown mouseup mousemove mouseleave mouseover".concat(
  ...
  (e.TimepickerUI = class {
    constructor(e, c) {
      ...
      (this.create = () => {
        ...
        (this._getInputValueOnOpenAndSet = () => {
          var e, i;
          const t = r(this.input, this._options.clockType);
          if (void 0 === t)
            return (
              (this.hour.innerText = "12"),
              (this.minutes.innerText = "00"),
              o(this._element, "show", {
          ...
          const { hour: n, minutes: s, type: a } = t;
          (this.hour.innerText = n), (this.minutes.innerText = s);
        ...
        (this._handleCancelButton = () => {
          this._clickTouchEvents.map((e) => {
            this.cancelButton.addEventListener(e, () => {
              var e;
              const i = r(this.input, this._options.clockType);
              o(
                this._element,
                "cancel",
        ...
        (this._handleOkButton = () => {
          this._clickTouchEvents.map((e) => {
            this.okButton.addEventListener(e, () => {
              var e, i;
              const t = this._handleValueAndCheck(
                  this.hour.textContent,
                  "hour"
                ),
        ...
        (this._handleBackdropClick = () => {
          this._clickTouchEvents.map((e) => {
            this.modalElement.addEventListener(e, (e) => {
              ...
              const s = r(this.input, this._options.clockType);
              o(
                this._element,
                "cancel",
        ...
        (this._removeBgColorToCirleWithMinutesTips = () => {
          (this.minutes.textContent && k.includes(this.minutes.textContent)) ||
            ((this.circle.style.backgroundColor = ""),
          ...
          this._clickTouchEvents.map((e) => {
            this.AM.addEventListener(e, (e) => {
              ...
              e.target.classList.add(d),
                this.PM.classList.remove(d),
                o(this._element, "selectamtypemode", {
                  hour: this.hour.textContent,
                  minutes: this.minutes.textContent,
                  type:
                    null === (i = this.activeTypeMode) || void 0 === i
        ...
        (this._handlePmClick = () => {
          this._clickTouchEvents.map((e) => {
            this.PM.addEventListener(e, (e) => {
              var i;
              e.target.classList.add(d),
                this.AM.classList.remove(d),
                o(this._element, "selectpmtypemode", {
                  hour: this.hour.textContent,
                  minutes: this.minutes.textContent,
                  type:
                    null === (i = this.activeTypeMode) || void 0 === i
          ...
          this._clickTouchEvents.map((e) => {
            this.hour.addEventListener(e, (e) => {
              ...
              null !== this.clockFace && this._handleAnimationSwitchTipsMode(),
                ...
                n.classList.add(d),
                this.minutes.classList.remove(d),
                o(this._element, "selecthourmode", {
                  hour: this.hour.textContent,
                  minutes: this.minutes.textContent,
                  type:
          ...
          this._clickTouchEvents.map((e) => {
            this.minutes.addEventListener(e, (e) => {
              ...
              null !== this.clockFace &&
                ...
                n.classList.add(d),
                this.hour.classList.remove(d),
                o(this._element, "selectminutemode", {
                  hour: this.hour.textContent,
                  minutes: this.minutes.textContent,
                  type:
                    null === (t = this.activeTypeMode) || void 0 === t
        ...
        (this._handleEventToMoveHand = (e) => {
          ...
          const b = t(e, this.clockFace),
            v = this.clockFace.offsetWidth / 2;
          let g = b && Math.atan2(b.y - v, b.x - v);
          if (s()) {
            const i = t(e, this.clockFace, !0);
            if (!i) return;
            g = Math.atan2(i.y - v, i.x - v);
          }
          if ("mouseup" === u || "touchend" === u)
            return (
              ...
              void (
                k &&
                (n(d, "timepicker-ui-value-tips") ||
                  n(d, "timepicker-ui-value-tips-24h") ||
                  n(d, "timepicker-ui-tips-wrapper")) &&
                this.minutes.click()
              )
            );
          if (
            (("mousedown" !== u &&
              ...
              (n(d, "timepicker-ui-clock-face") ||
              n(d, "timepicker-ui-circle-hand") ||
              n(d, "timepicker-ui-hour-time-12") ||
              n(d, "timepicker-ui-minutes-time") ||
              n(d, "timepicker-ui-clock-hand") ||
              n(d, "timepicker-ui-value-tips") ||
              n(d, "timepicker-ui-value-tips-24h") ||
              n(d, "timepicker-ui-tips-wrapper") ||
              n(d, "timepicker-ui-tips-wrapper-24h")
          ...
          if (null !== this.minutesTips) {
            ...
            let e,
              t = g && a(Math.trunc((180 * g) / Math.PI) + 90, h, 6);
            if (void 0 === t) return;
            t < 0
              ? ((e = Math.round(360 + t / 6) % 60),
                (t = 360 + 6 * Math.round(t / 6)))
              : ((e = Math.round(t / 6) % 60), (t = 6 * Math.round(t / 6))),
              ...
              o(
                ...
                "update",
                Object.assign(
                  Object.assign({}, r(this.input, this._options.clockType)),
                  {
                    degreesHours: this._degreesHours,
                    degreesMinutes: this._degreesMinutes,
                    eventType: u,
          ...
          const f = p ? p[0] : void 0,
            y = p && f ? document.elementFromPoint(f.clientX, f.clientY) : null;
          if (null !== this.hourTips) {
            if (
              (this.hour.classList.add("active"),
              !n(y || d, "timepicker-ui-value-tips-24h") ||
                n(y || d, "timepicker-ui-value-tips") ||
                n(y || d, "timepicker-ui-tips-wrapper"))
            ) {
              this.removeCircleClockClasses24h();
              let e,
                i = g && a(Math.trunc((180 * g) / Math.PI) + 90, m, 30);
              if (
            ...
            if (
              n(y || d, "timepicker-ui-value-tips-24h") ||
              n(y || d, "timepicker-ui-tips-wrapper-24h")
            ) {
              this.setCircleClockClasses24h();
              let e,
                i = g && a(Math.trunc((180 * g) / Math.PI) + 90, m, 30);
        ...
        (this._handlerClickHourMinutes = (e) =>
          i(this, void 0, void 0, function* () {
            ...
            const i = e.target,
              ...
              o = this._handleValueAndCheck(
                this.minutes.textContent,
                "minutes"
              );
            if (this._options.editable)
              if (n(i, "timepicker-ui-hour") || n(i, "timepicker-ui-minutes"))
                (!1 !== r && !1 !== o) ||
        ...
        (this._options = ((e, i) => Object.assign(Object.assign({}, i), e))(
          Object.assign(
            ...
            ((e) => {
              ...
              null === (v = this._element) || void 0 === v ? void 0 : v.dataset
            )
          ),
          u
        )),
    ...
    setErrorHandler() {
      ...
      const {
        ...
        currentType: l,
        currentLength: u,
      } = r(this.input, this._options.clockType);
      if (s) {
        ...
        throw (
          ...
          r.classList.add("timepicker-ui-invalid-text"),
          (r.innerHTML = "<b>Invalid Time Format</b>"),
          (null === (i = this.input) || void 0 === i
            ...
            (null === (n = this.input) || void 0 === n || n.after(r)),
          o(this._element, "geterror", {
            error: s,
            currentHour: a,
            currentMin: c,
            currentType: l,
    ...
    _setOnStartCSSClassesIfClockType24h() {
      if ("24h" === this._options.clockType) {
        const { hour: e } = r(this.input, this._options.clockType);
