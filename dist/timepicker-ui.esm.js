    ...
    e(this, 'create', () => {
      ...
      e(this, '_handleEventToMoveHand', (e) => {
        ...
        const { type: i, target: t } = e,
          ...
          { x: s, y: h } = a(e, this.clockFace),
          p = this.clockFace.offsetWidth / 2;
        let k = Math.atan2(h - p, s - p);
        if (d()) {
      ...
      (this._isTouchMouseMove = !1),
      (this._degreesHours = 30 * Number(l(this.input).hour)),
      (this._degreesMinutes = 6 * Number(l(this.input).minutes)),
      (this._isMobileView = !1),
      (this._isDesktopView = !0),
...
new k(document.querySelector('.timepicker-ui'), { theme: 'crane-radius', mobile: !0 }).create();
export default k;
