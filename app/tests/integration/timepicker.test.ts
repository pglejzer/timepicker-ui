...
describe('TimepickerUI', () => {
  ...
  describe('Constructor', () => {
    ...
    it('should generate UUID if no custom ID provided', () => {
      ...
      expect(timepicker._instanceId).toBeDefined();
      expect(timepicker._instanceId).toMatch(/^timepicker-ui-/);
    });
    ...
    it.skip('should set focusTrap to false for inline mode by default', () => {
      ...
      expect(timepicker._options.focusTrap).toBe(false);
    });
    ...
    it('should merge dataset options with provided options', () => {
      ...
      expect(timepicker._options.theme).toBe('dark');
      expect(timepicker._options.clockType).toBe('24h');
    });
  });
  ...
  describe('Public Methods', () => {
    ...
    describe('create()', () => {
      it('should initialize timepicker', () => {
        ...
        expect(timepicker._isInitialized).toBe(true);
      });
    ...
    describe('open()', () => {
      ...
      it('should create timepicker if not initialized', async () => {
        expect(timepicker._isInitialized).toBe(false);
    ...
    describe('destroy()', () => {
      ...
      it('should remove instance from registry', () => {
        const id = timepicker._instanceId;
