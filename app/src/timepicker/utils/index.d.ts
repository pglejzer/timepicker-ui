...
export declare const typeCheckConfig: (
...
export declare const getClickTouchPosition: (
  event: TouchEvent,
  object: HTMLElement,
  isMobile?: boolean,
) =>
...
export declare const createNewEvent: (
  el: Element,
  eventName: string,
  value: {
    hour?: string | null;
...
export declare const debounce: <T extends (...args: any[]) => ReturnType<T>>(
  callback: T,
  timeout: number,
