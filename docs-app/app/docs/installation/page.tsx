...
*::after {
  box-sizing: border-box;
      ...
      <Section icon={Globe} title="CDN">
        ...
        <CodeBlock
          code={`<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/timepicker-ui@3.1.0/dist/css/main.css">
<script src="https://cdn.jsdelivr.net/npm/timepicker-ui@3.1.0/dist/index.js"></script>`}
          language="html"
        />
      </Section>
